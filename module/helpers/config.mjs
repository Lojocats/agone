...
AGONE.peuplesData = {
  ...
  humain:    {
    taiBase: 0, corpsBonus: 0, espritBonus: 0, ameBonus: 0,
  ...
  geant:     {
    ...
    taiBase: 3, corpsBonus: 0, espritBonus: 0, ameBonus: 0,
  ...
  feeNoire:  {
    ...
    taiBase: -2, corpsBonus: 0, espritBonus: 0, ameBonus: 0,
    agiliteBonus: 0,   agiliteMin: null, agiliteMax: null,
  ...
  pixie:     {
    taiBase: -2, mvBase: 5, corpsBonus: 0, espritBonus: 0, ameBonus: 0,  // mvBase=5 : MV spécial (vol)
